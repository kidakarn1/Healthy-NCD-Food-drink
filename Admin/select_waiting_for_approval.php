...
if ($_SESSION[user] != ""and $_SESSION[status] == "Admin") {
    ...
    <html lang="en">
        ...
        <body background="">
            ...
            <?php
            $spt = 0 + $_GET[sp];
            $sql1 = "select*from user,member where user.user_id=member.mem_id and user.status='Pending'  limit $spt,10";
            $res1 = mysqli_query($conn, $sql1);
            ?>
            <div class='container'>
                    ...
                    <table class="table table-striped table-condensed table-hover">
                        ...
                        <td style="color:#ffffff; background-color: green;" ><center><b>อนุมัติ/ไม่อนุมัติ</b></center></td>
                        </tr>
                        <?php
                        while ($row1 = mysqli_fetch_array($res1)) {
                            ...
                            <td><center><a href="fromeditmemberadmin.php?id=<?php echo $row1[mem_id] ?>"><font color="#000000 "size="3">การจัดการ</font></a></center></td>
                            <td><center><a href="update_status_user.php?id=<?php echo $row1['mem_id'] ?>" onClick="javascript:return confirm('คุณแน่ใจใช่มั้ยว่าจะอนุมัติ');"><font color="#0000ff">อนุมัติ</font></a> / <a href="delect_Pending.php?id=<?php echo $row1[mem_id] ?>" onClick="javascript:return confirm('คุณแน่ใจหรือไม่ว่าจะไม่อนุมัติ');">ไม่อนุมัติ</a></center></td>
                            </tr>
                        <?php } ?>
                    </table>
                    <center>
