...
if ($_SESSION[user] != ""and $_SESSION[status] == "Admin") {
    ...
    <html lang="en">
        ...
        <body>
            ...
            ?>
            <?php
            $sql1 = "select* from food where dis_id='1' and cat_id='1' order by food_id asc";
            $res1 = mysqli_query($conn, $sql1);
            ?>
            <div class='container '>
                <div class="panel-heading">
                    <center><h3>รายชื่อาหาร <?php echo $row_name['dis_name'] ?></h3></center>
                </div>
                <div class=" panel panel-primary">
                    ...
                    <table class="table table-striped table-condensed table-hover">
                        ...
                        while ($row1 = mysqli_fetch_array($res1)) {
                            ...
                            <th><center><button type="button" class="btn btn-primary btn-xs  " data-toggle="modal" data-target="#myModal<?php echo $row1['food_id'] ?>"> วัตถุดิบ</button></center></th>
                        ...
                        <center><a href="#frominsertstaff"data-toggle="modal" data-target="#insertproductadmin"><font color="#ffffff">เพิ่มข้อมูลสินค้า</font></a> <a href="insert_product.php"><font color="#ffffff">1</font></a> <a href="insert_product2.php"><font color="#ffffff">2</font></a> <a href="insert_product3.php"><font color="#ffffff">3</font></a> <a href="insert_product4.php"><font color="#ffffff">4</font></a> </center>
                        </td>
                        </tr>
                    </table>
