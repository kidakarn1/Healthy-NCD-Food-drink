...
if ($_SESSION[user] != ""and $_SESSION[status] == "Admin") {
    ...
    <html lang="en">
        ...
        <body background='image/ui.jpg'>
            ...
            $sqld = "select * from order_ncd,food,member where order_ncd.order_date='$date' and order_ncd.Meal='พิเศษ' and order_ncd.food_id=food.food_id and order_ncd.mem_id=member.mem_id order by order_ncd.order_id asc ";
            ...
            <div class="container">
                    <div class="panel-heading">
                        <center>
                            <div class="row">
                                <div class="col-md-12 ">
                                    <h2><?php echo "รายการสั่งซื้อ พิเศษ" ?></h2>
                                </div>
                            </div> 
                            <div class="row">
                                <div class="col-md-12">
                                            ...
                                            <div class="tableproduct thumbnail ">
                                                ...
                                                <center>
                                                    <div class=" tableproduct1 caption">
                                                        <img src="../img_products/<?php echo $rowd['image'] ?>" width="50%"><br>
                                                        <h5>อาหาร <?php echo $rowd["food_name"] . " " . "ราคา" . " " . $rowd['price_sum'] . " " . "จำนวน" . " " . $rowd['order_number']; ?></h5>
                                                        <h5>ชื่อ <?php echo $rowd["fname"] . " " . $rowd["lname"]; ?></h5>
                                                        <form action='inorder.php' method='post' name='form2' id='form2'>

                                                            <font color="#FFFF00">เวลาที่สั่งซื้อ<?php echo" " . $rowd['time'] ?></font><br><p></p>
                                                            ที่อยู่<?php echo " " . $rowd['home_number'] . " " . $rowd['mooban'] . " " . $rowd['Road'] . " " . $rowd['aumpher'] . " " . $rowd['province'] ?>
                                                            <br><br>
                                                            เบอร์โทรศัพท์:<?php echo " " . $rowd['telephone']; ?>
                                                        </form>
                                                        <?php // }   ?>
                                                    </div>
                                                </center>
