...
<?php 
include("../conn.php");
$sql="select * from evaluation where eva_id='$id'";
$res=mysqli_query($conn,$sql);
$row=mysqli_num_rows($res);
$eva_id=$row+1;
?>
<form method="post" action="pcAddevaluation.php">


	<div class="col-md-offset-5">ลำดับ :<input type="text" name="eva_id"></div><br>
