...
if ($_SESSION[user] != ""and $_SESSION[status] == "Admin") {
    ...
    <html lang="en">
        <head>
            ...
            <link href="../css/boดนนotstrap.css" rel="stylesheet">
        ...
        <body>
            ...
            <?php
            $usernumber = $_GET['id'];
            $sql = "select * from category_foods";
            $res = mysqli_query($conn, $sql);
            ?>
            <div class='container'>
                <div class="panel-heading"><center><h3><b>ประเภทอาหาร</b></h3></center></div>
                <div class=" panel panel-primary">
                    ...
                    <table class="table table-striped table-condensed table-hover">
                        ...
                        <?php while ($row = mysqli_fetch_assoc($res)) { ?>
                            <tr>
                                <td><center><?php echo $row['cat_id']; ?></center></td>
