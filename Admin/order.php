...
if ($_SESSION[user] != ""and $_SESSION[status] == "Admin") {
    ...
    <html lang="en">
        ...
        <body background="">
            ...
            $sqld = "select * from order_ncd,food,member where order_ncd.order_date='$date' and order_ncd.Meal='มื้อเช้า' and order_ncd.food_id=food.food_id and order_ncd.mem_id=member.mem_id order by order_ncd.order_id asc ";
            ...
            <div class="container">
                    <div class="panel-heading">
                        <center>
                            <div class="row">
                                <div class="col-md-12 ">
                                    <h2><?php echo "รายการสั่งซื้อ ช่วงเช้า" ?></h2>
                                </div>
                            </div> 
                            <div class="row">
                                <div class="col-md-12">
                    ...
                    <div class="three">
                        <div class="panel-body">
                            <div class="form-group">
                                <?php
                                /* เนื่องจาก'$_SESSION[disease]เป็นค่าว่าง จึงเลยต้องดึงข้อมูลมาใหaม่ */
