...
<html lang="en">
    ...
    <body>
        ...
        include("../conn.php");
        include('menu.php');
        $sql1 = "select* from knowledge,image_kno where knowledge.kno_id='2' and knowledge.kno_id=image_kno.kno_id";
        $res1 = mysqli_query($conn, $sql1);
        $row1 = mysqli_fetch_array($res1);

        $sql2 = "select* from image_kno where img_id='4' and kno_id='2'";
        $res2 = mysqli_query($conn, $sql2);
        $row2 = mysqli_fetch_array($res2);

        $sql3 = "select* from image_kno where img_id='5' and kno_id='2'";
        $res3 = mysqli_query($conn, $sql3);
        $row3 = mysqli_fetch_array($res3);

        $sql4 = "select* from image_kno where img_id='6' and kno_id='2'";
        ...
        <div class='container'>
            ...
            <div class=" panel panel-primary">
                ...
                <div class="three panel-body">
                    <form class="form-horizontal" method="post" action="edit_disease.php?id=<?php echo '2' ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-offset-1 col-md-5">
                                ...
                                <input type="hidden" name="img_name6"value="<?php echo $row2['img_name']; ?>" >

                            </div>

                            <div class="col-md-5">
                                <img src="../tip_dis/<?php echo $row3['img_name'] ?>" width="425"  height="400">
                                <input type="hidden" name="img_name7"value="<?php echo $row3['img_name']; ?>" >
                        ...
                        <div class="form-group">
                            <div class=" col-md-12">
                                ...
                                <input type="hidden" name="img_name8"value="<?php echo $row4['img_name']; ?>">
