            ...
            <div class="container">
                <div class="navbar-inverse">
                    ...
                    <div class="three panel panel-default ">
                        ...
                        <?php
                        $spt = 0 + $_GET[sp];
                        $sql5 = "select* from user where user.status='User'order by user.user_id DESC limit $spt,10";
                                                            ...
                                                            <th colspan="0" bgcolor="#ffcc33"><center>สถานะ</th>
                                                                <th colspan="0" bgcolor="#ffcc33"><center></th>
                                                                    <th bgcolor="#ffcc33"><center>ลบ</th>
                                                                        ...
                                                                        <th><center><?php echo $row5[user_id]; ?></center></th>

                                                                        <th><center><a href="name_order.php?id=<?php echo $row5[user_id]; ?>"><font color="#0000ff"><?php echo $row5[user_id]; ?></font></a></center></th>
