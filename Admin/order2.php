...
if ($_SESSION[user] != ""and $_SESSION[status] == "Admin") {
    ...
    <html lang="en">
        ...
        <body background='image/ui.jpg'>
            ...
            $sqld = "select * from order_ncd,food,member where order_ncd.order_date='$date' and order_ncd.Meal='มื้อเย็น' and order_ncd.food_id=food.food_id and order_ncd.mem_id=member.mem_id order by order_ncd.order_id asc ";
            ...
            <div class="container">
                <div class="panel-heading">
                    <center>
                        <div class="row">
                            <div class="col-md-12 ">
                                <h2><?php echo "รายการสั่งซื้อ ช่วงเย็น" ?></h2>
                            </div>
                        </div> 
                        <div class="row">
                            <div class="col-md-12">
