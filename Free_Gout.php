...
<html lang="en">
    <head>
        ...
        $sql = "select * from food where food.dis_id='3' and cat_id='1' order by rand() LIMIT 9";
        $res = mysqli_query($conn, $sql);

        $sql_name = "select * from disease where dis_id='3'";
...
// echo $a[$random_keys[2]];
        ...
        <div class="panel">
            ...
            <div class="panel-heading"><center><h3><?php echo "อาหารสำหรับ" . " " . $row_name['dis_name'] ?></h3></center>
                <div class="row">
                    <div class="col-md-offset-9 col-md-3 ">
                        <form method="post" action="select_Gout_all.php">
                            <button type="submit" class="col-md-12 btn btn-sm btn-warning  ">
                                <font color="#000000">รายการอาหาร<?php echo $row_name['dis_name'] ?>ทั้งหมด</font></button>
                        </form>
                    </div>
                </div>
            </div>
