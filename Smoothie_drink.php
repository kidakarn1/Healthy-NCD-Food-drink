        ...
        <div class="container">
            <div class="navbar-inverse">
                ...
                <div class="three panel panel-default">
                    ...
                    <div class="panel-heading"><center><h3>เครื่องดื่มปั่น </h3></center>
                        <div class="row">
                    ...
                    <div class="three panel-body">
                        ...
                        <?php
                        $sql = "select * from product where cat_id='3' order by pro_id";
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-3">
                                    <div class="tableproduct thumbnail ">
                                        ...
                                        <img src="img_products/<?php echo $row["image"]; ?>" alt="..." width="30%"><br>
                                        <center>
 ...
 <h5><?php echo $row["pro_name"] . " " . $row["Description"]; ?><p></p>
                                                ...
                                                <form action='inorder.php' method='post' name='form2' id='form2'>
                                                    ...
                                                    จำนวน <select name="number"id="number">
                                                        ...
                                                        <input type="submit" class="btn btn-sm btn-success" name="button" id="button"  value="หยิบใส่ตะกร้า"/>
